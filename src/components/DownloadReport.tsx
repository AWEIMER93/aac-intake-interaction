...
${result.recommendations.map(rec => {
  // Format varies based on category type
  if (rec.category === 'Picture & Symbol Themes' || 
      rec.category === 'Interface Modifications' || 
      rec.category === 'Additional Features') {
...
Generated by AAC Customization Specialists AI
    ...
    link.href = url;
    link.download = `AAC_Recommendations_${result.clientName.split(',')[0].replace(/\s+/g, '_')}.txt`;
  ...
  return (
    <div className="subtle-card p-8 max-w-md mx-auto text-center appear-animate" style={{ animationDelay: '0.5s' }}>
      ...
      <p className="text-muted-foreground mb-6">
        Your customized AAC recommendations for {result.clientName.split(',')[0]} are ready to download.
      </p>
